...
CREATE TABLE IF NOT EXISTS `TB_FOTA_CAMPAIGN`
(
...
CREATE TABLE IF NOT EXISTS `TB_SUPPORT_MODEL`
(
...
CREATE TABLE IF NOT EXISTS `TB_DEVICE_DETAIL`
(
...
CREATE TABLE IF NOT EXISTS `TB_DEVICE_GROUP_MAP`
(
...
CREATE TABLE IF NOT EXISTS `TB_DEVICE_TAG_MAP`
(
...
CREATE TABLE IF NOT EXISTS `TB_PV_FIRMWARE_MAIN`
(
...
CREATE TABLE IF NOT EXISTS `TB_FOTA_CAMPAIGN_DEVICE_MAP`
(
...
CREATE TABLE IF NOT EXISTS `TB_FOTA_PACKAGE`
(
...
CREATE TABLE IF NOT EXISTS `TB_FOTA_CAMPAIGN_PACKAGE_MAP`
(
...
CREATE TABLE IF NOT EXISTS `TB_FOTA_DEVICE_GROUP_MAP`
(
...
CREATE TABLE IF NOT EXISTS `TB_FOTA_DEVICE_TAG_MAP`
(
...
CREATE TABLE IF NOT EXISTS `TB_OPERATION_QUEUE`
(
    `ID`        bigint      PRIMARY KEY AUTO_INCREMENT,
    `DEVICE_ID` bigint      NOT NULL,
    `PAYLOAD`   json        NULL,
